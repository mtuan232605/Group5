...
void abcd()
{
	...
	gotoxy(15,2);
 	printf("===>");
 	SetTeColor(14);
 	char *_="Mai Duc Phong Thien :))";
	int __=3**_+5;
	printf("\n\n    \t\t\t");
	printf(_,__+59,__-32,__-19,__-4,__-21,__-40,__+17,__-7,__-21,__-44,__-19,__-17,__-9,__-15,__-2,__+58);//dong nay kho hieu nen viet bang ki tu thuong
	printf("\n\n");
}
void reset();
void intro();
...
void menu()
{
	...
	if(chon == 3)
	{
		system("cls");
		SetTeColor(04);
		printf("\n\t(*) Dung 4 phim a w d s de dieu khien con ran, dam dau zo tuong la chet\n\n");
